...
GROUND = pygame.transform.scale(pygame.image.load(os.path.join('Assets', 'MainGround.jpg')), (WIDTH, HEIGHT))

BLACKBG = pygame.transform.scale(pygame.image.load(os.path.join('Assets', 'BlackBG.jpg')), (WIDTH, HEIGHT))
